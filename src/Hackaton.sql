-- CREATE TABLE Statements (senza commenti)
CREATE TABLE users (
...
INSERT INTO organizers (user_email) VALUES
                                        ('alice.smith@example.com'),
                                        ('eve.davis@example.com');

INSERT INTO judges (user_email) VALUES
    ('diana.miller@example.com');

INSERT INTO hackathons (title, location, start_date, end_date, max_participants, max_team_size, registration_start, registration_end, problem_description, organizer_user_email) VALUES
...
INSERT INTO teams (team_name, hackathon_id, max_members) VALUES
                                                             ('Eco Innovators', 1, 5),
                                                             ('Neural Coders', 2, 4),
                                                             ('Pixel Pioneers', 3, 3),
                                                             ('Green Minds', 1, 5);

INSERT INTO participants (user_email, hackathon_id, team_id) VALUES
                                                                 ('bob.johnson@example.com', 1, NULL),
                                                                 ('charlie.brown@example.com', 1, NULL),
                                                                 ('frank.green@example.com', 2, NULL);

UPDATE participants SET team_id = 1 WHERE user_email = 'bob.johnson@example.com' AND hackathon_id = 1;
UPDATE participants SET team_id = 1 WHERE user_email = 'charlie.brown@example.com' AND hackathon_id = 1;
UPDATE participants SET team_id = 2 WHERE user_email = 'frank.green@example.com' AND hackathon_id = 2;

INSERT INTO documents (document_path, upload_date, team_id) VALUES
...
INSERT INTO requests (message, status, team_id, sender_participant_email, receiver_participant_email) VALUES
...
INSERT INTO votes (score, team_id, judge_user_email, hackathon_id) VALUES
                                                                       (8, 1, 'diana.miller@example.com', 1),
                                                                       (9, 2, 'diana.miller@example.com', 2),
                                                                       (7, 3, 'diana.miller@example.com', 3);

INSERT INTO judge_hackathons (judge_user_email, hackathon_id) VALUES
